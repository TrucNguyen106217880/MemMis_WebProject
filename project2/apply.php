		...
		<form action="process_eoi.php" method="post" id="apply_form" novalidate>
			...
			<fieldset>
				...
				<fieldset class="inputs_group">
					<legend>AI313</legend>
					<span>
						<input type="checkbox" id="skill_10" name="AI313[]" value="10">
					...
					<span>
						<input type="checkbox" id="skill_11" name="AI313[]" value="11">
						<label for="skill_11">1+ years of experience as an AI engineer.</label>						
					</span>
					<span>
						<input type="checkbox" id="skill_12" name="AI313[]" value="12">
					...
					<span>
						<input type="checkbox" id="skill_13" name="AI313[]" value="13">
