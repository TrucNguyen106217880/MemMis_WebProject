...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2025 at 04:57 AM
...
(1, 'Bachelor\'s Degree in Software Engineering or related field'),
(2, '1+ years of software developing experience'),
(3, 'Familiarity with Agile development methodology'),
(4, 'Ability to define and solve logical problems for highly technical applications'),
(5, 'Proven experience in software development (e.g., internships, projects, or professional roles)'),
(6, 'Proficiency in one or more programming languages (e.g., Java, Python, C#, JavaScript)'),
(7, 'Attention to details'),
(8, 'Excellent communication skill'),
(9, 'Keep up to date with new technology'),
(10, 'Bachelor\'s or Master\'s degree in Computer Science, Artificial Intelligence, Data Science, or related field'),
(11, '1+ years of experience as an AI engineer'),
(12, 'Strong programming skills in Python and experience with ML libraries such as TensorFlow, PyTorch, Scikit-learn'),
(13, 'Familiarity with cloud platforms (e.g., AWS, Azure, GCP) and containerization tools (e.g., Docker, Kubernetes)'),
(14, 'Experience with data preprocessing, feature engineering, and model evaluation'),
(15, 'Familarity with Agile development method'),
(16, 'Attention to details'),
(17, 'Keep up to date with new technology'),
(18, 'Bachelor\'s or Master\'s degree in cybersecurity or related field'),
(19, '2+ years of experience in cybersecurity or IT security roles'),
(20, 'Knowledge of security frameworks and standards (e.g., NIST, ISO 27001, CIS)'),
(21, 'Strong understanding of network protocols, operating systems, and security tools'),
(22, 'Able to work both independently and on a team');
COMMIT;
